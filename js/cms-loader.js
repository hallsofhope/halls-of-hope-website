...
class HallsOfHopeCMS {
    ...
    updateFooter(footer, general) {
        ...
        const footerLinks = document.querySelector('.footer-bottom-links') || document.querySelector('.footer-bottom .footer-links');
        if (footerLinks) {
            let links = [];
            if (footer.show_privacy) {
                links.push(`<a href="${footer.privacy_url || 'privacy.html'}">Privacy Policy</a>`);
            }
            if (footer.show_terms) {
                links.push(`<a href="${footer.terms_url || 'terms.html'}">Terms of Service</a>`);
            }
            if (footer.show_refund) {
                links.push(`<a href="${footer.refund_url || '#'}">Refund Policy</a>`);
            }
            if (footer.show_disclaimer) {
                links.push(`<a href="${footer.disclaimer_url || 'disclaimer.html'}">Earnings Disclaimer</a>`);
            }
